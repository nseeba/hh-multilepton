...
void SVfit4tauResolutionHistManager::bookHistograms(TFileDirectory& dir)
{
  ...
  histogram_dihiggsRatioMass1_  = book1D(dir, "dihiggsRatioMass1", "dihiggsRatioMass1", 100,    0.,    10.);
  histogram_ditau1DeltaMass1_   = book1D(dir, "ditau1DeltaMass1",  "ditau1DeltaMass1",  400, -200.,  +200.);
  histogram_ditau1RatioMass1_   = book1D(dir, "ditau1RatioMass1",  "ditau1RatioMass1",  100,    0.,    10.);
  histogram_ditau2DeltaMass1_   = book1D(dir, "ditau2DeltaMass1",  "ditau2DeltaMass1",  400, -200.,  +200.);
  histogram_ditau2RatioMass1_   = book1D(dir, "ditau2RatioMass1",  "ditau2RatioMass1",  100,    0.,    10.);
  ...
  histogram_dihiggsRatioMass2_  = book1D(dir, "dihiggsRatioMass2", "dihiggsRatioMass2", 100,    0.,    10.);
  histogram_ditau1DeltaMass2_   = book1D(dir, "ditau1DeltaMass2",  "ditau1DeltaMass2",  400, -200.,  +200.);
  histogram_ditau1RatioMass2_   = book1D(dir, "ditau1RatioMass2",  "ditau1RatioMass2",  100,    0.,    10.);
  histogram_ditau2DeltaMass2_   = book1D(dir, "ditau2DeltaMass2",  "ditau2DeltaMass2",  400, -200.,  +200.);
  histogram_ditau2RatioMass2_   = book1D(dir, "ditau2RatioMass2",  "ditau2RatioMass2",  100,    0.,    10.);
...
namespace
{
  void fillSVfit4tauResolutionHistograms(const SVfit4tauResult& result,
					 ...
					 TH1* histogram_dihiggsDeltaMass, TH1* histogram_dihiggsRatioMass,
					 TH1* histogram_ditau1DeltaMass, TH1* histogram_ditau1RatioMass,
					 TH1* histogram_ditau2DeltaMass, TH1* histogram_ditau2RatioMass,
					       ...
					       double evtWeight)
{
  ...
  if ( results.size() >= 1 ) {
	...
	histogram_dihiggsDeltaMass1_, histogram_dihiggsRatioMass1_,
	histogram_ditau1DeltaMass1_, histogram_ditau1RatioMass1_,
	histogram_ditau2DeltaMass1_, histogram_ditau2RatioMass1_,
  ...
  if ( results.size() >= 2 ) {
	...
	histogram_dihiggsDeltaMass2_, histogram_dihiggsRatioMass2_,
	histogram_ditau1DeltaMass2_, histogram_ditau1RatioMass2_,
	histogram_ditau2DeltaMass2_, histogram_ditau2RatioMass2_,
