#include "hhAnalysis/multilepton/interface/EvtHistManager_hh_2lss_leq1tau_vbf.h"
...
EvtHistManager_hh_2lss_leq1tau_vbf::EvtHistManager_hh_2lss_leq1tau_vbf(const edm::ParameterSet & cfg)
  : HistManagerBase(cfg)
{
...
const TH1 *EvtHistManager_hh_2lss_leq1tau_vbf::getHistogram_EventCounter() const {
  return histogram_EventCounter_;
}

void EvtHistManager_hh_2lss_leq1tau_vbf::bookHistograms(TFileDirectory &dir) {
