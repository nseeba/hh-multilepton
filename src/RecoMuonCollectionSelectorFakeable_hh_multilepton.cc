...
void
RecoMuonSelectorFakeable_hh_multilepton::set_min_lepton_pt(double min_lepton_pt)
{
...
void
RecoMuonSelectorFakeable_hh_multilepton::set_assocJetBtag(bool flag)
{
  useAssocJetBtag_ = flag;
}

double
RecoMuonSelectorFakeable_hh_multilepton::get_min_lepton_pt() const
{
