...
# file generated at 2019-11-14 14:38:42 with the following command:
# create_dictionary.py -m python/samples/metaDict_2017_hh_DeepTauIDv2p1.py -p python/samples/sampleLocations_2017_nanoAOD_hh_multilepton_DeepTauIDv2p1.txt -N samples_2017 -E 2017 -o python/samples -g hhAnalyzeSamples_2017_nanoAOD_DeepTauIDv2p1.py -M
