...
# create_dictionary.py -m python/samples/metaDict_2016_hh_DeepTauIDv2p1.py -p python/samples/sampleLocations_2016_nanoAOD_hh_multilepton_DeepTauIDv2p1.txt -N samples_2016 -E 2016 -o python/samples -g hhAnalyzeSamples_2016_nanoAOD_DeepTauIDv2p1.py -M
