...
class analyzeConfig_Zjetsctrl_fakes(analyzeConfig_hh):
  """Configuration metadata needed to run analysis in a single go.

  Sets up a folder structure by defining full path names; no directory creation is delegated here.

  Args specific to analyzeConfig_Zjetsctrl_fakes:
  ...
  def __init__(self,
    ...
    '''
    print "analyzeConfig_Zjetsctrl_fakes::__init__: lepton_genMatches_nonfakes:",self.lepton_genMatches_nonfakes,\
    ...
    self.histogramDir_prep_dcard = "Zjetsctrl_fakes_OS_Tight"
    self.histogramDir_prep_dcard_SS = "Zjetsctrl_fakes_SS_Tight"
    self.make_plots_backgrounds = self.get_makeplots_backgrounds()

    self.cfgFile_make_plots = os.path.join(self.template_dir, "makePlots_Zjetsctrl_fakes_cfg.py")
    self.cfgFile_make_plots_mcClosure = os.path.join(self.template_dir, "makePlots_mcClosure_Zjetsctrl_fakes_cfg.py") #TODO
  ...
  def createCfg_analyze(self, jobOptions, sample_info, lepton_selection):
    """Create python configuration file for the analyze_Zjetsctrl_fakes executable (analysis code)
    ...
    Args:
      ...
      central_or_shift: either 'central' or one of the systematic uncertainties defined in $CMSSW_BASE/src/hhAnalysis/multilepton/bin/analyze_Zjetsctrl_fakes.cc
    """
    ...
    lines = super(analyzeConfig_Zjetsctrl_fakes, self).createCfg_analyze(jobOptions, sample_info)
