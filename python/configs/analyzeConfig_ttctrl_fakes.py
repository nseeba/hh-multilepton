...
class analyzeConfig_ttctrl_fakes(analyzeConfig_hh):
  """Configuration metadata needed to run analysis in a single go.

  Sets up a folder structure by defining full path names; no directory creation is delegated here.

  Args specific to analyzeConfig_ttctrl_fakes:
  ...
  def __init__(self,
    ...
    self.prep_dcard_processesToCopy = [ "data_obs" ] + self.nonfake_backgrounds + [ "Convs", "data_fakes", "fakes_mc", "data_flips", "flips_mc" ] + self.get_samples_categories_HH()
  ...
  def createCfg_analyze(self, jobOptions, sample_info, lepton_selection):
    """Create python configuration file for the analyze_ttctrl_fakes executable (analysis code)
    ...
    Args:
      ...
      central_or_shift: either 'central' or one of the systematic uncertainties defined in $CMSSW_BASE/src/hhAnalysis/multilepton/bin/analyze_ttctrl_fakes.cc
    """
    ...
    lines = super(analyzeConfig_ttctrl_fakes, self).createCfg_analyze(jobOptions, sample_info)
