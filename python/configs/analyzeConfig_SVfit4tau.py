...
class analyzeConfig_SVfit4tau(analyzeConfig):
  ...
  def __init__(self, configDir, outputDir, executable_analyze, cfgFile_analyze, samples,
               lepton_selection, hadTau_selection, SVfit4tau_logM_wMassConstraint, SVfit4tau_logM_woMassConstraint, central_or_shifts,
  ...
  def createCfg_analyze(self, jobOptions):
    ...
    lines.append("process.analyze_SVfit4tau.SVfit4tau_logM_wMassConstraint = cms.double(%1.1f)" % jobOptions['SVfit4tau_logM_wMassConstraint'])
    lines.append("process.analyze_SVfit4tau.SVfit4tau_logM_woMassConstraint = cms.double(%1.1f)" % jobOptions['SVfit4tau_logM_woMassConstraint'])
