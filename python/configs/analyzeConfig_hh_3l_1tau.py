        ...
        for chargeSumSelection in self.chargeSumSelections:
          ...
          for genMatch_category in genMatch_categories:
            for signal_base, signal_input in self.signal_io.items():
              key_addBackgrounds_job_signal = getKey(lepton_and_hadTau_selection_and_frWeight, chargeSumSelection, signal_base)
              ...
              if key_addBackgrounds_job_signal in self.jobOptions_addBackgrounds_sum.keys():
                continue
              cfg_key = getKey(self.channel, signal_base, genMatch_category, lepton_and_hadTau_selection_and_frWeight, chargeSumSelection)
