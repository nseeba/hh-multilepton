...
from hhAnalysis.multilepton.configs.analyzeConfig_hh_2lss_leq1tau import analyzeConfig_hh_2lss_leq1tau
...
# E.g.: ./test/hhAnalyzeRun_2lss_leq1tau.py -v 2017Dec13 -m default -e 2017
