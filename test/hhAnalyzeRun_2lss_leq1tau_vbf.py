...
from hhAnalysis.multilepton.configs.analyzeConfig_hh_2lss_leq1tau_vbf import analyzeConfig_hh_2lss_leq1tau_vbf
...
# E.g.: ./test/hhAnalyzeRun_2lss_leq1tau_vbf.py -v 2017Dec13 -m default -e 2017
...
if __name__ == '__main__':
  ...
  analysis = analyzeConfig_hh_2lss_leq1tau_vbf(
    ...
    executable_analyze                    = "analyze_hh_2lss_leq1tau_vbf",
    cfgFile_analyze                       = "analyze_hh_2lss_leq1tau_vbf_cfg.py",
    samples                               = samples,
