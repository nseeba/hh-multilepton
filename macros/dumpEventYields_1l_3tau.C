...
void dumpEventYields()
{
  ...
  std::string inputFilePath = "/hdfs/local/acwarden/hhAnalysis/2017/2020May18/histograms/hh_1l_3tau";
  ...
  inputFileNames["hh_1l_3tau"] = "histograms_harvested_stage2_hh_1l_3tau_Tight_OS.root";
