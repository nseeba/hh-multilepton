...
void PlotHistos1DAndRatioPlot() {
  ...
  */
  ...
  std::string sanaVersion = "20210319_hh_3l_UnskimmedNTuples";
  std::string sHHDecayMode = "hh_2v2t";
  ...
  //std::string sVersion0 = Form("%s_%s_%s",sEra.c_str(),sanaVersion.c_str(),sHHDecayMode.c_str());
  std::string sVersion0 = Form("%s_%s_hh",sEra.c_str(),sanaVersion.c_str());
  std::string sVersion = Form("%s_%s",sVersion0.c_str(),sExt.c_str());
  ...
  */
  ...
  vHistoDetails.push_back({			  
      ...
      {sHistoName,   Form("HHatLOvsNLO_OS_Tight/sel/evt/signal_ggf_nonresonant_hh/gen_mHH_%i",histoVersion)},
      {sLegend,      "LO SM (unweighted)"},
      {sHistoNorm,   "1."},
      {sLineColor,   "2"},
      {sMarkerColor, "2"},
      {sMarkerStyle, "25"}
  ...
  vHistoDetails.push_back({			  
      {sipFile,      Form("/home/ssawant/ana/hhwwww/20201102_BDTTraining/Datacards_3l/ggHH_SM_LO_vs_NLO/analyze_HHatLOvsNLO/%s/analyze_signal_ggf_nonresonant_node_sm_%s*.root",sVersion.c_str(),sHHDecayMode.c_str())},
      {sHistoName,   Form("HHatLOvsNLO_OS_Tight/sel/evt/signal_ggf_nonresonant_hh/gen_mHH_LOtoNLOrwgt_%i",histoVersion)},
      {sLegend,      "LO SM * LOtoNLO weight"},
      {sHistoNorm,   "1."},
      {sLineColor,   "46"},
      {sMarkerColor, "46"},
      {sMarkerStyle, "23"}
  ...
  std::string sSaveAs = Form("gen_mHH_SM_LO_vs_NLO_%s_%s_%s_%s_20210319_2_logX",sEra.c_str(),sVersion0.c_str(),sHHDecayMode.c_str(),sExt1.c_str());
