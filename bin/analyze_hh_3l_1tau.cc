...
/*
      ...
      if(isSignal)
      {
        for(const std::string & decayMode_evt: decayModes_evt)
        {
          ...
          selHistManager -> evt_in_decayModes_[decayMode_evt] = new EvtHistManager_hh_3l_1tau(makeHistManager_cfg(
...
//--- compute MHT and linear MET discriminant (met_LD)
    ...
    double m4Vis_presel = (preselLepton_lead->p4() + preselLepton_sublead->p4() + preselLepton_third->p4() + preselHadTau->p4()).mass();
...
//    and for e->tau and mu->tau misidentification rates
    ...
    double m4Vis_sel = (selLepton_lead->p4() + selLepton_sublead->p4() + selLepton_third->p4() + selHadTau->p4()).mass();
    double m4_sel_1 = -1.; 
    double m4_sel_2 = -1.; 
    ...
    measuredTaus.push_back(selHadTau);
