#ifndef hhAnalysis_multilepton_RecoMuonCollectionSelectorTight_hh_multilepton_h
#define hhAnalysis_multilepton_RecoMuonCollectionSelectorTight_hh_multilepton_h

#include "tthAnalysis/HiggsToTauTau/interface/ParticleCollectionSelector.h" // ParticleCollectionSelector
#include "tthAnalysis/HiggsToTauTau/interface/RecoMuon.h" // RecoMuon
#include "tthAnalysis/HiggsToTauTau/interface/analysisAuxFunctions.h"       // Era

class RecoMuonSelectorTight_hh_multilepton
{
public:
  explicit
  RecoMuonSelectorTight_hh_multilepton(Era era,
                           int index = -1,
                           bool debug = false,
...
//-------------------------------------------------------------------------------
  ...
  const bool apply_jetBtagCSVLoose_;
  const bool apply_jetBtagCSVInterp_;

  double
  smoothBtagCut(double assocJet_pt) const;
};

class RecoMuonCollectionSelectorTight_hh_multilepton
  : public ParticleCollectionSelector<RecoMuon, RecoMuonSelectorTight_hh_multilepton>
{
public:
  explicit
  RecoMuonCollectionSelectorTight_hh_multilepton(Era era,
                                     int index = -1,
                                     bool debug = false,
                                     bool set_selection_flags = true);
  ~RecoMuonCollectionSelectorTight_hh_multilepton() {}
};

#endif // hhAnalysis_multilepton_RecoMuonCollectionSelectorTight_hh_multilepton_h
