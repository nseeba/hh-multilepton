#ifndef hhAnalysis_multilepton_RecoElectronCollectionSelectorTight_hh_multilepton_h
#define hhAnalysis_multilepton_RecoElectronCollectionSelectorTight_hh_multilepton_h

#include "tthAnalysis/HiggsToTauTau/interface/ParticleCollectionSelector.h" // ParticleCollectionSelector
#include "tthAnalysis/HiggsToTauTau/interface/RecoElectron.h" // RecoElectron
#include "tthAnalysis/HiggsToTauTau/interface/analysisAuxFunctions.h"       // Era

class RecoElectronSelectorTight_hh_multilepton
{
public:
  explicit
  RecoElectronSelectorTight_hh_multilepton(Era era,
                               int index = -1,
                               bool debug = false,
                               bool set_selection_flags = true);
  ~RecoElectronSelectorTight_hh_multilepton() {}
...
//-------------------------------------------------------------------------------
  ...
  const bool apply_jetBtagCSV_cut_;
  bool useAssocJetBtag_;                    ///< if true, use finalJets instead of updatedJets
};

class RecoElectronCollectionSelectorTight_hh_multilepton
  : public ParticleCollectionSelector<RecoElectron, RecoElectronSelectorTight_hh_multilepton>
{
public:
  explicit
  RecoElectronCollectionSelectorTight_hh_multilepton(Era era,
                                         int index = -1,
                                         bool debug = false,
                                         bool set_selection_flags = true);
  ~RecoElectronCollectionSelectorTight_hh_multilepton() {}

  void enable_offline_e_trigger_cuts();
  void disable_offline_e_trigger_cuts();
};

#endif // hhAnalysis_multilepton_RecoElectronCollectionSelectorTight_hh_multilepton_h
