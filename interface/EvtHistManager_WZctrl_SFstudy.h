#ifndef hhAnalysis_multilepton_EvtHistManager_WZctrl_SFstudy_h
#define hhAnalysis_multilepton_EvtHistManager_WZctrl_SFstudy_h

/** \class EvtHistManager_WZctrl_SFstudy
 *
...
{
 public:
  EvtHistManager_WZctrl_SFstudy(const edm::ParameterSet & cfg);
  ~EvtHistManager_WZctrl_SFstudy() {}
 ...
 private:
  ...
  TH1 * heventCategory_;
  //
  TH1 * hmvaOutput_xgb_WZctrl_SFstudy_SUMBk_HH_;
  //
  TH2 * hpt_vs_eta_lepton3_mu;
  TH2 * hpt_vs_eta_lepton3_e;
  //  
  TH1 * hEventCounter_;
};
