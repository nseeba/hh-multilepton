...
public:
  ...
  void fillHistograms(int numElectrons, int numMuons, int numJets, int numJetsPtGt40, int numBJets_loose, int numBJets_medium, double dihiggsVisMass, double dihiggsMass,
                      double HT, double STMET, double lep1_pt, double lep2_pt, double lep3_pt, double lep4_pt, double lep1_conePt, double lep2_conePt, double lep3_conePt,
                      double lep4_conePt, double lep1_eta, double lep2_eta, double lep3_eta, double lep4_eta, double lep1_phi, double lep2_phi, double lep3_phi,
                      double lep4_phi, double maxPtSum_pair1_pt, double maxPtSum_pair1_eta, double maxPtSum_pair1_phi, double maxPtSum_pair1_deltaEtaLep1,
                      ...
                      double maxPtSum_pair1_deltaPt, double maxPtSum_pair1_m, double maxPtSum_pair2_pt, double maxPtSum_pair2_eta, double maxPtSum_pair2_phi,
                      double maxPtSum_pair2_deltaEtaLep1, double maxPtSum_pair2_deltaPhiLep1, double maxPtSum_pair2_deltaEta, double maxPtSum_pair2_deltaPhi,
                      double maxPtSum_pair2_deltaR, double maxPtSum_pair2_deltaPt, double maxPtSum_pair2_m, double maxSubleadPt_pair1_pt, double maxSubleadPt_pair1_eta,
                      double maxSubleadPt_pair1_phi, double maxSubleadPt_pair1_deltaEtaLep1, double maxSubleadPt_pair1_deltaPhiLep1, double maxSubleadPt_pair1_deltaEta,
                      double maxSubleadPt_pair1_deltaPhi, double maxSubleadPt_pair1_deltaR, double maxSubleadPt_pair1_deltaPt, double maxSubleadPt_pair1_m,
                      double maxSubleadPt_pair2_pt, double maxSubleadPt_pair2_eta, double maxSubleadPt_pair2_phi, double maxSubleadPt_pair2_deltaEtaLep1,
                      ...
                      double maxSubleadPt_pair2_deltaPt, double maxSubleadPt_pair2_m, double minDeltaRSum_pair1_pt, double minDeltaRSum_pair1_eta,
                      ...
                      double minDeltaRSum_pair1_deltaPhi, double minDeltaRSum_pair1_deltaR, double minDeltaRSum_pair1_deltaPt, double minDeltaRSum_pair1_m,
                      double minDeltaRSum_pair2_pt, double minDeltaRSum_pair2_eta, double minDeltaRSum_pair2_phi, double minDeltaRSum_pair2_deltaEtaLep1,
                      double minDeltaRSum_pair2_deltaPhiLep1, double minDeltaRSum_pair2_deltaEta, double minDeltaRSum_pair2_deltaPhi, double minDeltaRSum_pair2_deltaR,
                      double minDeltaRSum_pair2_deltaPt, double minDeltaRSum_pair2_m, double minSubclosestDeltaR_pair1_pt, double minSubclosestDeltaR_pair1_eta,
                      double minSubclosestDeltaR_pair1_phi, double minSubclosestDeltaR_pair1_deltaEtaLep1, double minSubclosestDeltaR_pair1_deltaPhiLep1,
                      double minSubclosestDeltaR_pair1_deltaEta, double minSubclosestDeltaR_pair1_deltaPhi, double minSubclosestDeltaR_pair1_deltaR,
                      double minSubclosestDeltaR_pair1_deltaPt, double minSubclosestDeltaR_pair1_m, double minSubclosestDeltaR_pair2_pt,
                      ...
                      double METDeltaPhiLep1, double MET_LD, double HTmiss, int lep1_isElectron, int lep1_charge, int lep2_isElectron, int lep2_charge,
                      int lep3_isElectron, int lep3_charge, int lep4_isElectron, int lep4_charge, int leptonChargeSum, int electronChargeSum, int muonChargeSum,
                      int nSFOS, double evtWeight);
