...
public:
  ...
  void fillHistograms(
		      int numElectrons, int numMuons, int numLeptons, int numJets, int numJetsPtGt40, int numBJets_loose, int numBJets_medium, double dihiggsVisMass, double dihiggsMass, 
		      ...
		      double lep4_conePt, double lep1_eta, double lep2_eta, double lep3_eta, double lep4_eta, double lep1_phi, double lep2_phi, double lep3_phi, double lep4_phi, 
		      double lep1_dxy, double lep2_dxy, double lep3_dxy, double lep4_dxy, double lep1_dz, double lep2_dz, double lep3_dz, double lep4_dz, double pt4l, 
		      double pt4lParallelHadT, double pt4lPerpendicularHadT, double mt4l, double maxPtSum_pair1_pt, double maxPtSum_pair1_eta, double maxPtSum_pair1_phi, 
		      double maxPtSum_pair1_deltaEtaLep1, double maxPtSum_pair1_deltaPhiLep1, double maxPtSum_pair1_deltaEta, double maxPtSum_pair1_deltaPhi, double maxPtSum_pair1_deltaR, 
		      ...
		      double maxPtSum_pair2_deltaEtaLep1, double maxPtSum_pair2_deltaPhiLep1, double maxPtSum_pair2_deltaEta, double maxPtSum_pair2_deltaPhi, double maxPtSum_pair2_deltaR, 
		      double maxPtSum_pair2_deltaPt, double maxPtSum_pair2_m, double MET, double METParallelHadT, double METPerpendicularHadT, double METPhi, double METDeltaPhiLep1, 
		      double MET_LD, double HTmiss, int lep1_isElectron, int lep1_charge, int lep2_isElectron, int lep2_charge, int lep3_isElectron, int lep3_charge, int lep4_isElectron, 
		      int lep4_charge, int leptonChargeSum, int electronChargeSum, int muonChargeSum, int nSFOS, double evtWeight);
